...
// in simulator we redefine to format for AkuraruDefault Developer console
...
{\
	NSString * exceptionName = [@"org.akurarudefault." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.akurarudefault";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIAkuraruDefaultNativeItemNone = -1, 
	UIAkuraruDefaultNativeItemSpinner = -2,
	UIAkuraruDefaultNativeItemProgressBar = -3,
	
	UIAkuraruDefaultNativeItemSlider = -4,
	UIAkuraruDefaultNativeItemSwitch = -5,
	UIAkuraruDefaultNativeItemMultiButton = -6,
	UIAkuraruDefaultNativeItemSegmented = -7,
	
	UIAkuraruDefaultNativeItemTextView = -8,
	UIAkuraruDefaultNativeItemTextField = -9,
	UIAkuraruDefaultNativeItemSearchBar = -10,
	
	UIAkuraruDefaultNativeItemPicker = -11,
	UIAkuraruDefaultNativeItemDatePicker = -12,
	
	UIAkuraruDefaultNativeItemInfoLight = -13,
	UIAkuraruDefaultNativeItemInfoDark = -14,
	
	UIAkuraruDefaultNativeItemDisclosure = -15,
	
	UIAkuraruDefaultNativeItemContactAdd = -16
};
