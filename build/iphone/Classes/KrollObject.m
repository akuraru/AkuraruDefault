 ...
 * Copyright (c) 2009-2011 by AkuraruDefault, Inc. All Rights Reserved.
...
//@interface AkuraruDefaultObject : NSObject
//@end

@interface AkuraruDefaultObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[AkuraruDefaultObject class]])
		{
			for (NSString *key in [[(AkuraruDefaultObject*)o modules] allKeys])
			{
