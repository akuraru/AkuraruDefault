...
@interface AkuraruDefaultObject : KrollCoverageObject {
#else
@interface AkuraruDefaultObject : KrollObject {
#endif
@private
...
extern NSString * AkuraruDefault$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	AkuraruDefaultObject *_akurarudefault;
	BOOL shutdown;
